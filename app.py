...
Days_to_subtractX = 20
Days_to_subtract = Days_to_subtractX
...
if role == "admin" and tab2:
    with tab2:
        ...
        Days_to_subtractX = Days_to_subtract
        st.text_input("عدد الايام التي سيتم طرحها في صفحة الإدخال (تأثير رجعي)", value=Days_to_subtractX, key="admin_days_input")
